        ...
        const groqResponse = await fetch("https://api.groq.com/openai/v1/chat/completions", {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: "system",
                        content: "You are Predixo, an AI forecasting assistant."
                    },
                    {
                        role: "user",
                        content: `Predict upcoming trend for: ${keyword}`
                    }
                ]
            })
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__20dc864d._.js.map